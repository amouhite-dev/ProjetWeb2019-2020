 <!DOCTYPE html> 
    <html>
        ...
        <a class = "titre" href = "AccueilVendeur.php"><h1 class = "titre">G-MARKET</h1></a>
				...
				<div class="card">
					...
					<hr>
				  	...
				  	<ul class="list-group list-group-flush">
					    <li class="list-group-item"><i class="fas fa-clock"></i><a href="HistoriqueVendeur.php"> Historiques </a></li>

					    <li class="list-group-item"><i class="fas fa-home"></i><a href="AccueilVendeur.php">  Retour à l'accueil</a></li>
