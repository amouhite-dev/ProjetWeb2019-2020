...
<?php
		...
		try {
			...
			$sql =" SELECT  produits.nom as n ,description, users.uid as u,qte,prix,login, pid FROM 
			produits INNER JOIN users WHERE ctid = 1 AND produits.uid = users.uid";
	...
	?>
			    <div class="row row-cols-1 row-cols-md-3">
					...
					?>
							<div class="col mb-4">
							    <div class="card">
							        <img src="../images/alimentsPhoto.jpg" class="card-img-top" alt="photo aliment">
							        <div class="card-body">
